...
describe("index", () => {
  ...
  it("should call a command", async () => {
    ...
    expect(select).toHaveBeenCalledWith(
      {
        ...
        choices: [
          ...
          },
          {
            name: "Prime Numbers",
            value: "prime-numbers",
            description: "Returns all prime numbers that are bellow the entered number",
          },
          {
          ...
          },
          {
            ...
            value: "lcm",
            description: "Returns the lowest common multiple of the entered numbers",
          },
        ],
      },
      {
    ...
    expect(logSpy).toHaveBeenCalledWith(chalk.greenBright("Greatest Common Divisor (GCD)"));
  });
});
